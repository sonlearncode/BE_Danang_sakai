// --- HELPER: Hàm tạo slug tiếng Việt (Tự động xử lý) ---
const toSlug = (str) => {
    return str
        .toLowerCase()
        .normalize("NFD")
...
// Helper để tạo object topic nhanh gọn
const createTopic = (name, description) => ({
    name,
    slug: toSlug(name), // Tự động sinh slug
    description
});
...
// DỮ LIỆU CHUYÊN ĐỀ CHI TIẾT (Sử dụng hàm createTopic)
const TOPIC_DATA = {
    'toan-hoc': [
